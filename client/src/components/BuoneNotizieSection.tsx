/**
 * BuoneNotizieSection — Sezione Buone Notizie con anchor e numerazione
 * Sezione 8: Buone Notizie, Sezione 9: Statistiche
 */
  ...
  return (
    <section id="buone-notizie" className="py-16 sm:py-20 px-4 sm:px-5 relative overflow-hidden">
      <div className="max-w-[1000px] mx-auto">
        ...
        {/* === SEZ 8: Buone Notizie === */}
        <div id="sez-buone-notizie" className="scroll-mt-24">
          <SectionLabel number={8} color="green" />
        ...
        {/* === SEZ 9: Statistiche === */}
        <div id="sez-statistiche" className="scroll-mt-24">
          <SectionLabel number={9} color="green" />
